      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="order-2 md:order-1">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-emerald-800">What is Chiuri Butter?</h2>
            <p className="text-lg text-gray-700 mb-4">
              ...
              from seeds of butter tree, which grows at altitudes between 300-1500 meters.
            </p>
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 bg-emerald-100 p-3 rounded-lg shadow-md">
