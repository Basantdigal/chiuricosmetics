      ...
      <div className="container mx-auto">
        ...
        <div className="mt-12 text-center">
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
            By choosing chiuri butter products, you're supporting conservation efforts like the
            Bagmati Provincial Government's program, which aims to protect and sustainably utilize
